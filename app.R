...
shinyServer <- function(input, output, session) {
  ...
  observeEvent(input$confirmButton, {
    ...
    system2(command="sed", args = c("-i", "-e", paste0("s/Bananaman1s_Bar_PE27_6TN/", venueName, "/g"), shQuote("/home/shiny/OrderApp/venueinfo.R")), stdout = shQuote("/home/shiny/OrderApp/venueinfo.R"))
    ...
    #system2(command="sed", args = c("-i", "-e", paste0("s/replaceThisPassword/", venuePassword, "/g"), "/home/shiny/OrderApp/venueinfo.R"), stdout = TRUE, stderr = TRUE)
    
    #REPLACE venuename IN SHELL SCRIPT TO CREATE GCP RESOURCES
    
    system2(command="sed", args = c("-i", "-e", paste0("s/venuename/", gsub("_", "-", tolower(venueName)), "/g"), "/home/shiny/shinymenu-registration-app/GCP-shinymenu-startup.sh"), stdout = TRUE, stderr = TRUE)
